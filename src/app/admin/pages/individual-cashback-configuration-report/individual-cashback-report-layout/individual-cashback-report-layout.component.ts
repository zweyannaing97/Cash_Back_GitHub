...
export class IndividualCashbackReportLayoutComponent implements OnInit {
  ...
  displayedColumns: string[] = ['companyName', 'divisionState', 'district', 'township', 'cityTown', 'agentCode', 'branch','confType', 'okAccNum', 'cashbackOkAcc', 'serviceCategory', 'okAccType', 'cashbackOpWise','cashbackTelenorNo','cashbackMptNo','cashbackOoredooNo','cashbackMytelNo','cashbackMectelNo','cashbackGiftCardsNo','cashbackDTHNo','cashbackElecNo','cashbackPostPaidNo','country','cashbackOvSeasNo','createDateTime','updateDateTime','refNum','status'];
