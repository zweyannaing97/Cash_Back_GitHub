...
export class ViewCompanyWiseReportDetailComponent implements OnInit {
  ...
  displayedColumns2: string[] = ['companyName', 'divisionState', 'district','township','cityTown', 'agentCode', 'branch','refNum','okAccNum','okAccType','address','postalCode','totalPaidAmt','totalGeneAmt','cashbackOkAccNo','cashbackTelenorNo','telenorPaidAmt','telenorCashback','cashbackMPTNo','mptPaidAmt','mptCashback','cashbackOoredooNo','ooredooPaidAmt','ooredooCashback','cashbackMytelNo','mytelPaidAmt','mytelCashback','cashbackMectelNo','mectelPaidAmt','mectelCashback','cashbackGiftCardNo','giftcardPaidAmt','giftcardCashback','cashbackDTHNo','dthPaidAmt','dthCashback','cashbackElecNo','elecPaidAmt','elecCashback','cashbackOvseasNo','ovseasPaidAmt','ovseasCashback','sumTotalCashbackRecAmt','transactionDateTime','latitude','longitude','status'];
