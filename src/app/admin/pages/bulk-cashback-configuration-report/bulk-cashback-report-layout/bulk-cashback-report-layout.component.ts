...
@Component({
  ...
  templateUrl: './bulk-cashback-report-layout.component.html',
  styleUrls: ['./bulk-cashback-report-layout.component.scss']
})
export class BulkCashbackReportLayoutComponent implements OnInit {
  ...
  @ViewChild("tableHeight") tableHeight: ElementRef | undefined;
  ...
  actionEvent(event: any){
    if (event.type == "view") {
      ...
      console.log(document.getElementsByClassName("dataTable")[0]);
      document.getElementsByClassName("dataTable")[0].setAttribute("style", "height: 100%;");
