...
export declare function isDisabledDate(date?: Date, datesDisabled?: Date[], unit?: string): boolean;
export declare function isEnabledDate(date?: Date, datesEnabled?: Date[], unit?: string): boolean;
